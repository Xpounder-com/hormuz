...
export default function PrivacyPage() {
  return <PageFrame active="privacy">
    ...
    <section className="section prose-section">
      ...
      <h2>Interactive examples</h2><p>The company report, policy editor, compaction inspector, setup selector, and question search use fictional or synthetic data and temporary state in your browser. They do not connect to a gateway, read your local AI usage, apply policies, or send example choices and search text to Hormuz. A download or checkout link click is not proof of installation, activation, payment, or delivery of paid services.</p>
