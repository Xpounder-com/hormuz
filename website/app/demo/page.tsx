...
export const metadata = pageMetadata('Try Hormuz — A $1M AI budget, explained', 'Explore team and token costs, compare policy changes, inspect exact context compaction, and find your installation path.', '/demo/');

export default function DemoPage() {
  return <PageFrame active="demo"><PageHero eyebrow="Use the product before you install" title={<>Your AI budget.<br /><span>Your next decision.</span></>}><p>Explore a company managing $1 million a year in AI. Drill into the token costs, try a policy, and inspect what changes on the next request.</p><div className="hero-actions"><a className="button button-primary" href="#experience">Explore the example ↓</a><CampaignLink className="button button-ghost" href={sitePath('/docs/')}>Install free →</CampaignLink></div></PageHero>
    <CustomerExperience />
    <QuestionIndex />
    <details className="section disclosure"><summary>Technical evidence: recorded CLI runs, transcripts, and exports</summary>
