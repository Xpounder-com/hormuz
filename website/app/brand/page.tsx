  ...
  return <PageFrame active="brand">
    ...
    <section className="brand-section" id="identity">
      ...
      <div className="brand-icon-system" id="icons">
        ...
        <p>Download the full set from 16 to 1024 px, including scalable SVGs and multi-resolution ICO files.</p><CampaignLink href={sitePath('/brand/hormuz-icons.zip')} download>Download all icon sizes ↓</CampaignLink>
      </div>
    </section>
