...
const faqs = [
  ...
  ['How does context optimization handle my data?', 'The planned Hormuz 1.2 feature is optional and Off by default. Eligible repetitive tool results are encoded and verified on your device; one selected representation then travels through your configured Hormuz gateway, where the usual controls still apply. It is an encoding, not encryption, and savings are not guaranteed.'],
];
