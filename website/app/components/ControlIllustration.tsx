...
export function ControlIllustration({ index }: { index: number }) {
  return <div className={`control-art control-art-${index}`} aria-hidden="true">
    {index === 0 && <><span className="art-app">⌘<small>Codex</small></span><i>→</i><span className="art-hormuz"><BrandMark /></span><i>←</i><span className="art-app">✳<small>Claude Code</small></span></>}
