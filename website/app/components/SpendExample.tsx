  ...
  return <div className="spend-example">
    ...
    <div className="spend-workspace">
      ...
      <div className="token-detail">
        <div className="detail-toolbar"><h4>What drives the cost?</h4><label><span className="sr-only">Filter model</span><select aria-label="Filter model" value={model} onChange={event => setModel(event.target.value)}><option>All models</option><option>Advanced</option><option>Standard</option></select></label></div>
