...
Hormuz HTTP transport
        ...
        +--> inspect JSON and allowlisted provider headers at the final DLP boundary
        +--> detect, redact, require approval, or deny without mutating keys/headers
