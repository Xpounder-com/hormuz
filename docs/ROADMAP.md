...
- local and GitHub package/client verification, including two independent exact-commit builds under pinned Python packaging inputs, byte-identical wheels and canonical source archives, and a content-free hash manifest; this does not yet prove cross-builder OCI image reproducibility or an observed published release;
