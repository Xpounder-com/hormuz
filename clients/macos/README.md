...
Code is installed separately. The signed customer app supports Apple Silicon
(`arm64`) on macOS 14 or later; Intel Macs are neither built nor tested. Clean
machine and exact-architecture distribution validation remain release gates.
