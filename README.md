...
- Exact-source `linux/amd64` OCI rebuilding exports one committed revision twice through BuildKit, validates every referenced OCI descriptor and layer, requires byte-identical layouts, and emits a deterministic image tar plus content-free digest evidence before either artifact is accepted.
