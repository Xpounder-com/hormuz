...
- Disabled-by-default automatic injection of verified organization/team/person Context Packs into user-priority OpenAI Responses and Anthropic Messages content, with monotonic policy caps, complete post-mutation DLP, budget accounting, and metadata-only pack lineage.
