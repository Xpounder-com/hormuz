...
SQLITE_CASES = (
    ...
    "test_finance_account_binding_transition_preflight.SQLitePublishedAccountBindingPreflightTests.test_real_successor_preserves_published_predecessor",
    "test_finance_account_binding_transition_preflight.SQLitePublishedAccountBindingPreflightTests.test_real_ddl_failure_rolls_back_and_retry_is_idempotent",
    "test_finance_account_binding_transition_preflight.SQLitePublishedAccountBindingPreflightTests.test_published_binary_refuses_newer_and_both_refuse_partial_without_repair",
    ...
    "test_finance_account_binding_transition_preflight.SQLitePublishedAccountBindingPreflightTests.test_post_checkpoint_write_requires_retained_forward_recovery",
    "test_linear_transition_preflight.SQLitePublishedLinearTransitionTests.test_missing_linear_successor_preserves_integrated_baseline",
    "test_linear_transition_preflight.SQLitePublishedLinearTransitionTests.test_test_only_linear_ddl_failure_rolls_back_and_retry_is_idempotent",
    "test_linear_transition_preflight.SQLitePublishedLinearTransitionTests.test_published_and_current_binaries_refuse_partial_and_newer_without_repair",
    "test_linear_transition_preflight.SQLitePublishedLinearTransitionTests.test_quiesced_published_pair_restore_replays_original_receipt",
    "test_linear_transition_preflight.SQLitePublishedLinearTransitionTests.test_post_checkpoint_witness_requires_retained_forward_recovery",
    "test_association_transition_preflight.SQLitePublishedAssociationTransitionTests.test_missing_association_successor_preserves_integrated_baseline",
    "test_association_transition_preflight.SQLitePublishedAssociationTransitionTests.test_test_only_association_ddl_failure_rolls_back_and_retry_is_idempotent",
    "test_association_transition_preflight.SQLitePublishedAssociationTransitionTests.test_published_and_current_binaries_refuse_partial_and_newer_without_repair",
    "test_association_transition_preflight.SQLitePublishedAssociationTransitionTests.test_quiesced_published_pair_restore_replays_original_receipt",
    "test_association_transition_preflight.SQLitePublishedAssociationTransitionTests.test_post_checkpoint_witness_requires_retained_forward_recovery",
)
POSTGRES_CASES = (
    ...
    "test_finance_account_binding_transition_preflight.PostgresPublishedAccountBindingPreflightTests.test_real_successor_preserves_published_predecessor",
    "test_finance_account_binding_transition_preflight.PostgresPublishedAccountBindingPreflightTests.test_real_ddl_failure_rolls_back_and_retry_is_idempotent",
    "test_finance_account_binding_transition_preflight.PostgresPublishedAccountBindingPreflightTests.test_published_binary_refuses_newer_and_both_refuse_partial_without_repair",
    ...
    "test_finance_account_binding_transition_preflight.PostgresPublishedAccountBindingPreflightTests.test_post_checkpoint_write_requires_retained_forward_recovery",
    "test_linear_transition_preflight.PostgresPublishedLinearTransitionTests.test_missing_linear_successor_preserves_integrated_baseline",
    "test_linear_transition_preflight.PostgresPublishedLinearTransitionTests.test_test_only_linear_ddl_failure_rolls_back_and_retry_is_idempotent",
    "test_linear_transition_preflight.PostgresPublishedLinearTransitionTests.test_published_and_current_binaries_refuse_partial_and_newer_without_repair",
    "test_linear_transition_preflight.PostgresPublishedLinearTransitionTests.test_quiesced_published_pair_restore_replays_original_receipt",
    "test_linear_transition_preflight.PostgresPublishedLinearTransitionTests.test_post_checkpoint_witness_requires_retained_forward_recovery",
    "test_association_transition_preflight.PostgresPublishedAssociationTransitionTests.test_missing_association_successor_preserves_integrated_baseline",
    "test_association_transition_preflight.PostgresPublishedAssociationTransitionTests.test_test_only_association_ddl_failure_rolls_back_and_retry_is_idempotent",
    "test_association_transition_preflight.PostgresPublishedAssociationTransitionTests.test_published_and_current_binaries_refuse_partial_and_newer_without_repair",
    "test_association_transition_preflight.PostgresPublishedAssociationTransitionTests.test_quiesced_published_pair_restore_replays_original_receipt",
    "test_association_transition_preflight.PostgresPublishedAssociationTransitionTests.test_post_checkpoint_witness_requires_retained_forward_recovery",
)
