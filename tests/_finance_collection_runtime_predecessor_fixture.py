"""Verify and execute the exact merged schema-16 finance collection predecessor runtime."""
...
SOURCE_COMMIT = "0973662e57636b1dd6bbb6351c6cdde6676d3384"
ARCHIVE_SHA256 = "d7e6a0287ed8e527d365a121213eaa28e96a92f5b0e9f0e4caf67034dc3c0ae2"
ARCHIVE_PREFIX = "hormuz-finance-collection-runtime-baseline/"
RUNTIME_FILE_COUNT = 150
    ...
    try:
        ...
        for member in source_tar.getmembers():
            ...
            if (
                ...
                raise RuntimeError(
                    "finance_collection_runtime_predecessor_runtime_mismatch"
                )
        ...
        if len(expected) != RUNTIME_FILE_COUNT or actual != set(expected):
            raise RuntimeError("finance_collection_runtime_predecessor_runtime_mismatch")
...
def finance_collection_runtime_predecessor_call(request):
    executable = os.environ["HORMUZ_TEST_FINANCE_COLLECTION_RUNTIME_PYTHON"]
    ...
    if result.returncode:
        raise AssertionError("finance_collection_runtime_predecessor_driver_failed")
...
def _driver():
    ...
    if (
        ...
        or UsageStore.schema_version != 12
        or POSTGRES_SCHEMA_VERSION != 16
        ...
        raise RuntimeError("finance_collection_runtime_predecessor_binding_invalid")
    ...
    try:
        if request["backend"] == "sqlite":
            ...
            raise RuntimeError(
                "finance_collection_runtime_predecessor_backend_invalid"
            )
