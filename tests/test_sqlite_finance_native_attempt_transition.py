...
class SQLiteFinanceNativeAttemptTransitionTests(unittest.TestCase):
    def setUp(self):
        ...
        # checkout is v16; pin the fixture's starting point explicitly while
...
class SQLiteFinanceNativeAttemptPredecessorTests(unittest.TestCase):
    ...
    def test_post_checkpoint_write_requires_forward_recovery(self):
        self.probe()
        # The candidate now includes the v15 Linear reconciliation successor
        # on top of the v14 Linear connector migration.
