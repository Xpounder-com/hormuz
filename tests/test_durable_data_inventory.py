...
class DurableDataInventoryTests(unittest.TestCase):
    ...
    def test_current_inventory_covers_every_durable_class(self) -> None:
        ...
        self.assertEqual(result["database_class_count"], 31)
        self.assertEqual(result["sqlite_table_count"], 59)
        self.assertEqual(result["postgresql_table_count"], 68)
        self.assertEqual(result["operator_artifact_count"], 16)
