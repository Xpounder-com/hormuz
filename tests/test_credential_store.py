...
class CredentialStoreTests(unittest.TestCase):
    def test_missing_optional_keyring_fails_with_explicit_error(self) -> None:
        with mock.patch("hormuz.credential_store.keyring", None):
            with self.assertRaisesRegex(CredentialStoreError, "secure_store_dependency_missing"):
                SecureCredentialStore()
