...
from ._contract_schemas.policy import (
    ...
    _validate_policy_evaluation,
    _validate_policy_history,
    _validate_policy_preview,
    _validate_policy_scenario_suite,
...
def validate_contract(value: Mapping[str, Any]) -> None:
    ...
    validator = {
        ...
        (POLICY_SCENARIO_SUITE_SCHEMA_ID, POLICY_SCENARIO_SUITE_SCHEMA_VERSION): _validate_policy_scenario_suite,
        (POLICY_EVALUATION_SCHEMA_ID, POLICY_EVALUATION_SCHEMA_VERSION): _validate_policy_evaluation,
